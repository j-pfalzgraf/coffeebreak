...
pub static ENTRIES: super::Table = &[
    ...
    (super::Msg::DoctorColorNo, "non rilevato (imposta COLORTERM=truecolor)"),
    (super::Msg::DoctorLang, "Lingua"),
    (super::Msg::DoctorConfig, "File di config"),
    (super::Msg::DoctorConfigExists, "presente"),
    (super::Msg::DoctorConfigMissing, "non creato (esegui: coffeebreak config init)"),
    ...
    (super::Msg::DoctorNotifyNo, "nessun servizio di notifica rilevato"),
    (super::Msg::DoctorSound, "Audio"),
    (super::Msg::DoctorSoundChime, "carillon rodio (sound feature)"),
    ...
    (super::Msg::HelpDoctor, "Esegui diagnostica dell'ambiente (terminale, locale, config, …)"),
    ...
    (super::Msg::HelpGoal, "Obiettivo giornaliero di pomodori mostrato nelle statistiche (0 = disattivato)"),
    ...
    (super::Msg::WaitContinue, "Premi un tasto per continuare · q per uscire"),
    (super::Msg::WaitContinuePlain, "Premi Invio per continuare…"),
    (super::Msg::HelpWait, "Attendere un tasto tra le fasi invece di avanzare automaticamente"),
];
