...
pub static ENTRIES: super::Table = &[
    ...
    (super::Msg::DoctorColorNo, "não detetado (defina COLORTERM=truecolor)"),
    (super::Msg::DoctorLang, "Idioma"),
    (super::Msg::DoctorConfig, "Ficheiro de config"),
    (super::Msg::DoctorConfigExists, "presente"),
    (super::Msg::DoctorConfigMissing, "não criado (execute: coffeebreak config init)"),
    ...
    (super::Msg::DoctorNotifyNo, "nenhum serviço de notificação detetado"),
    ...
    (super::Msg::HelpDoctor, "Executa diagnósticos do ambiente (terminal, idioma, config, …)"),
    ...
    (super::Msg::HelpGoal, "Meta diária de pomodoros mostrada nas estatísticas (0 = desativada)"),
    ...
    (super::Msg::WaitContinue, "Pressione qualquer tecla para continuar · q para sair"),
    (super::Msg::WaitContinuePlain, "Pressione Enter para continuar…"),
    (super::Msg::HelpWait, "Aguardar uma tecla entre as fases em vez de avançar automaticamente"),
];
