...
pub static ENTRIES: super::Table = &[
    ...
    (
        ...
        "Imprime o valor de uma chave de configuração",
    ),
    (
        super::Msg::HelpConfigSet,
        "Define uma chave de configuração e guarda o ficheiro",
    ),
    (
        super::Msg::HelpConfigKey,
        "A chave a ler ou alterar (todas as chaves: `coffeebreak config show`)",
    ),
    (
        super::Msg::HelpConfigValue,
        "O novo valor (validado antes de guardar)",
    ),
    (super::Msg::ConfigSet, "Guardado {key} = {value}"),
    (
    ...
    (
        ...
        "Mostra o registo de sessões (ative com `history = true` na configuração)",
    ),
    (
        super::Msg::HelpHistoryLimit,
        "Mostra no máximo as últimas N sessões (0 = todas)",
    ),
    (
        super::Msg::HistoryTitle,
        "☕ coffeebreak — histórico de sessões",
    ),
    (
        super::Msg::HistoryEmpty,
        "Ainda não há sessões registadas. Defina `history = true` na configuração e conclua um bloco de foco. ☕",
    ),
